...
export type MeStatsOut = components["schemas"]["MeStatsOut"];
...
export type LocalSound = components["schemas"]["LocalSound"];
export type LocalCategory = components["schemas"]["LocalCategory"];
export type LocalSoundsOut = components["schemas"]["LocalSoundsOut"];
export type LocalImportIn = components["schemas"]["LocalImportIn"];
